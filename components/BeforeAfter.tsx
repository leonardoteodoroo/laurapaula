...
const CASES = [
  {
    ...
    description:
      "De gretas profundas que causavam dor ao caminhar, para uma pele totalmente íntegra e regenerada.",
    before:
      "https://cdn.shopify.com/s/files/1/0668/4275/5223/files/ressecamento_severo_nos_calcanhares.webp?v=1766991656&q=80&w=1000&auto=format&fit=crop",
    after:
      "https://cdn.shopify.com/s/files/1/0668/4275/5223/files/Reconstrucao_de_Fissuras.webp?v=1766901699&q=80&w=1000&auto=format&fit=crop",
  },
  {
    id: 2,
    title: "Plástica dos Pés (Efeito Rebote)",
    description:
      "Remoção da camada grossa e amarelada (queratose) sem cortes. O toque aveludado que volta já na primeira sessão.",
    before:
      "https://cdn.shopify.com/s/files/1/0668/4275/5223/files/spa_dos_pes_um_procedimento_que_trata_rachaduras_e_ressecamentos_voce_que_se_indentifica_com_e.webp?v=1766991004&q=80&w=1000&auto=format&fit=crop",
    after:
      "https://cdn.shopify.com/s/files/1/0668/4275/5223/files/spa_dos_pes_um_procedimento_que_trata_rachaduras_e_ressecamentos_voce_que_se_indentifica_com_e.webp?v=1766991004&q=80&w=1000&auto=format&fit=crop",
  },
  {
    ...
    description:
      "Aquele aspecto 'esbranquiçado' e áspero transformado em uma hidratação profunda que dura de verdade.",
    before:
      "https://cdn.shopify.com/s/files/1/0668/4275/5223/files/Antes_e_Depois_de_um_tratamento_profundo_para_pes_ressecados_e_com_rachaduras_Olha_essa_tra.webp?v=1766990687&q=80&w=1000&auto=format&fit=crop",
    after:
      "https://cdn.shopify.com/s/files/1/0668/4275/5223/files/Antes_e_Depois_de_um_tratamento_profundo_para_pes_ressecados_e_com_rachaduras_Olha_essa_tra_1.webp?v=1766990687&q=80&w=1000&auto=format&fit=crop",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg font-light">
            Para você parar de esconder o calcanhar toda vez que alguém olha
            para baixo.
          </p>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="overflow-hidden rounded-2xl bg-white/5 border border-white/5 p-4 md:p-8">
            <div
              key={currentIndex}
              className="flex flex-col md:grid md:grid-cols-2 gap-8 items-center animate-fade-in-up"
            >
