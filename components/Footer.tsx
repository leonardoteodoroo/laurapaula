  ...
  return (
    <footer className="py-24 bg-[#0a0c08] border-t border-white/5">
      <div className="container mx-auto px-4 flex flex-col items-center text-center">
        ...
        <div className="mb-8">
          <h3 className="font-serif text-4xl md:text-5xl text-off-white">Laura Paula</h3>
          <p className="text-emerald-500 text-sm uppercase tracking-[0.3em] mt-3">Especialista em Pés</p>
        </div>
