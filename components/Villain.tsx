    ...
    <section className="py-20 md:py-32 bg-dark-graphite relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mb-24">
          <div className="w-full md:w-1/2">
            ...
            <h2 className="font-serif text-3xl md:text-4xl text-off-white mb-6">
              O mais frustrante não é o pé rachado… é a sensação de que{" "}
              <span className="italic text-red-400">nada resolve.</span>
            </h2>
            <p className="text-gray-400 text-lg leading-relaxed mb-6">
              E, no fundo, talvez você já tenha até tentado de tudo. E nada
            ...
            <p className="text-emerald-400 text-sm italic border-l-2 border-emerald-500 pl-4">
              Existe um motivo claro para isso acontecer — e ele não tem nada a
              ver com você “cuidar errado”.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            >
              <img
                ...
                className={`w-full h-full object-cover transition-all duration-[1300ms] ease-in-out ${
                  isGrayscale
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <a
                  href={WHATSAPP_LINK}
                  className={`w-full block text-center bg-white/10 backdrop-blur-md border border-white/20 text-white py-3 rounded-lg hover:bg-emerald-900/50 transition-all duration-500 uppercase tracking-widest text-xs font-bold ${shouldPulse ? "scale-105 bg-emerald-900/60 shadow-lg shadow-emerald-500/20" : ""}`}
                >
                  Quero a Solução
                </a>
              </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12 bg-white/5 p-8 md:p-12 rounded-3xl border border-white/5">
          <div className="w-full md:w-1/2">
            <h2 className="font-serif text-3xl md:text-4xl text-off-white mb-6">
              Por que seus pés continuam{" "}
              <span className="italic text-emerald-400">rachando?</span>
            </h2>
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              Quase ninguém te conta isso, mas…{" "}
              <strong className="text-white">
                quando você lixa, sua pele entende que está sendo agredida.
              </strong>
            </p>
            <p className="text-gray-300 text-lg leading-relaxed mb-8">
              E aí ela reage criando ainda mais espessura para se defender. Ou
              seja:
              <br />
              <span className="block mt-4 text-center p-4 bg-dark-graphite/50 rounded-xl text-emerald-300 font-medium">
                Você lixa → fica lisinho por alguns dias →{" "}
                <span className="text-red-400">volta pior.</span>
              </span>
            </p>
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                <h3 className="text-xl font-medium text-off-white mb-2">
                  Isso tem nome:{" "}
                  <span className="text-red-400">Efeito Rebote.</span>
                </h3>
                <p className="text-sm text-gray-400">
                  Não é descuido. Não é falta de hidratação. Não é “coisa da
                  idade”. É só seu corpo tentando se proteger... E é justamente
                  isso que eu trato.
                </p>
              </div>
            </div>
            ...
            <a
              href={WHATSAPP_LINK}
              className="group w-full md:w-auto inline-flex items-center justify-center gap-3 bg-emerald-950/30 border border-emerald-500/30 backdrop-blur-sm px-8 py-4 rounded-xl text-emerald-400 font-medium tracking-widest uppercase text-xs hover:bg-emerald-900/40 hover:text-emerald-300 hover:border-emerald-400/50 transition-all duration-300 shadow-lg shadow-black/20 hover:shadow-emerald-900/20"
            >
              QUERO O TRATAMENTO CERTO
              <RefreshCw
                size={16}
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center p-6 bg-dark-graphite rounded-full shadow-2xl">
                <div>
                  <p className="font-serif text-5xl text-off-white mb-2">
                    Pare
                  </p>
