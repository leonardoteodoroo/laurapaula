...
const TESTIMONIALS = [
  {
    ...
    stars: 5,
    image:
      "https://ui-avatars.com/api/?name=Maria+R&background=047857&color=fff",
  },
  {
    id: 2,
    name: "Ana Paula S.",
    ...
    stars: 5,
    image:
      "https://ui-avatars.com/api/?name=Ana+Paula&background=047857&color=fff",
  },
  {
    id: 3,
    name: "Carla M.",
    ...
    stars: 5,
    image:
      "https://ui-avatars.com/api/?name=Carla+M&background=047857&color=fff",
  },
];
...
const SocialProof: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-24 bg-dark-graphite relative overflow-hidden"
    >
      {/* Background Decor */}
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-3xl md:text-5xl text-off-white mb-6">
            O que acontece quando você decide dar um basta no{" "}
            <span className="italic text-emerald-600">incômodo...</span>
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg font-light">
            Resultados reais de quem decidiu tratar a causa e abandonar o ciclo
            das lixas.
          </p>
        </div>
          ...
          {TESTIMONIALS.map((item, index) => (
            ...
            >
              ...
              <div className="pt-6 border-t border-white/5 flex items-center justify-between gap-4">
                <div>
                  <h4 className="text-off-white font-serif text-lg">
                    {item.name}
                  </h4>
                  <p className="text-xs text-emerald-400 uppercase tracking-wider mt-1">
                    {item.problem}
                  </p>
                </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-500 text-sm">
            Nota média de <strong className="text-off-white">5.0/5.0</strong>{" "}
            baseada em avaliações de pacientes.
          </p>
        </div>
      </div>
    </section>
