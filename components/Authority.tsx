        ...
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
          ...
          <div className="w-full md:w-1/2 order-1 md:order-2">
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-8 font-light">
              Atendo no meu estúdio em{" "}
              <strong className="text-white font-normal">
                São Sebastião do Paraíso - MG
              </strong>{" "}
              e trabalho exclusivamente com técnicas que tratam a causa,
              evitando o rebote das lixas comuns. É um atendimento individual,
              focado em resultado real e seguro.
            </p>

            <div className="relative p-8 bg-white/5 rounded-2xl border border-white/5 mb-10">
              <Quote
                className="absolute top-4 left-4 text-emerald-900/50"
                size={48}
              />
              <p className="relative z-10 font-serif italic text-gray-300 leading-relaxed text-lg">
                "Aquele incômodo áspero no lençol ou o medo de alguém notar seu
                pé descalço... eu sei como isso cansa. Meu trabalho é
                transformar essa frustração em alívio imediato. Vamos parar de
                esconder e começar a tratar do jeito certo?"
              </p>
              <p className="mt-4 text-right text-sm text-emerald-400 font-bold uppercase tracking-wider">
                — Laura Paula
              </p>
            </div>
