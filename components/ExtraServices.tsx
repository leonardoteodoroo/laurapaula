  ...
  const extras = [
    {
      ...
      image:
        "https://cdn.shopify.com/s/files/1/0668/4275/5223/files/E_essas_unhas_naturaisss_Brasil..._1.webp?v=1766995977?q=80&w=1000&auto=format&fit=crop", // Placeholder manicure
    },
    {
      title: "SPA Labial",
      subtitle:
        "O fim daquela sensação de boca ressecada que repuxa o dia todo.",
      image:
        "https://cdn.shopify.com/s/files/1/0668/4275/5223/files/spa_labial.jpg?v=1767003843?v=1767002943q=80&w=1000&auto=format&fit=crop", // Placeholder lips
    },
    {
      title: "Massagem Corporal",
      subtitle:
        "Para quando o peso da semana parece estar todo carregado nos seus ombros.",
      image:
        "https://cdn.shopify.com/s/files/1/0668/4275/5223/files/massagens_laura_puala.webp?v=1767004461?q=80&w=1000&auto=format&fit=crop", // Placeholder massage
    },
  ];
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl text-off-white">
            Onde o mundo lá fora para por um{" "}
            <span className="italic text-emerald-400">Instante</span>
          </h2>
        </div>
      </div>
